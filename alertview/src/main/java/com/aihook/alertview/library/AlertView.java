package com.aihook.alertview.library;
...
public class AlertView {
    ...
    protected void initViews() {
        ...
        if (style == Style.AlertDialog) {
            initAlertDialog(layoutInflater);
        } else {
    ...
    protected void initListView() {
        ListView alertButtonListView = null;
        if (style == Style.AlertDialog) {
            alertButtonListView = (ListView) rootView.findViewById(R.id.alertButtonListView);
        } else {
            alertButtonListView = (ListView) contentContainer.findViewById(R.id.alertButtonListView);
        }
        //把cancel作为footerView
...
//                if(onItemClickListener != null)onItemClickListener.onItemClick(AlertView.this,position);
    ...
    protected void initAlertDialog(LayoutInflater layoutInflater) {
        mAlertDialog = new AlertDialog.Builder(context).create();
        mAlertDialog.setCancelable(false);
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_alert, null);
        rootView = viewGroup;
        initHeaderView(viewGroup);
